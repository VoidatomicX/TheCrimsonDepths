...
import arsenal.the_crimson_depths.util.ModTags;
...
public enum ResoniteToolMaterials implements ToolMaterial {
    ...
    ResoniteToolMaterials(final TagKey<Block> inverseTag, final int itemDurability, final float miningSpeed, final float attackDamage,
